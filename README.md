...
- Шрифт, размер текста, цвет текста.

**Виджеты и удобства**

- Строка **быстрого поиска** с подсказками и выбором поисковика (Google / Яндекс / Bing).
- **Часы** (шрифт и размер настраиваются) и **погода** (город или координаты, размер, период обновления; клик открывает прогноз с датами — формат настраивается или отключается).
...
- **Сетка** — колонки и строки новых листов, прозрачность и цвет выделения.
