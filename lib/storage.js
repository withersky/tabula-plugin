...
const I18N = {
 ...
 weatherNoData: "Прогноз пока недоступен",
    ...
    optUiScale: "Общий масштаб виджетов и нижнего бара",
    ...
    groupPanelsCells: "Панели и ячейки",
    groupBackground: "Фон",
    groupColors: "Цвета и прозрачность",
    groupGrid: "Сетка",
    groupTypography: "Текст",
    groupBehaviour: "Поведение",
    searchSettingsPlaceholder: "Поиск по настройкам…",
    ...
    labelUiOpacity: "Прозрачность панелей и ячеек",
    labelUiOpacityHint: "",
    ...
    labelCellAlign: "Выравнивание надписей в ячейках",
    alignLeft: "Слева",
    alignCenter: "По центру",
    alignRight: "Справа",
    labelFaviconPosition: "Расположение иконки в ячейке",
    faviconPosLeft: "Слева от текста",
    faviconPosRight: "Справа от текста",
    faviconPosTop: "Над текстом",
    faviconPosBottom: "Под текстом",
 ...
 weatherNoData: "Forecast not available yet",
    ...
    optUiScale: "Widget & bottom bar scale",
    ...
    navAbout: "About",
    groupPanelsCells: "Panels & cells",
    groupBackground: "Background",
    groupColors: "Colors & opacity",
    groupGrid: "Grid",
    ...
    labelUiOpacity: "Panel & cell transparency",
    labelUiOpacityHint: "Dropdowns, widgets and cells — one slider",
    ...
    labelCellAlign: "Text alignment in cells",
    alignLeft: "Left",
    alignCenter: "Center",
    alignRight: "Right",
    labelFaviconPosition: "Icon position in cell",
    faviconPosLeft: "Left of text",
    faviconPosRight: "Right of text",
    faviconPosTop: "Above text",
    faviconPosBottom: "Below text",
